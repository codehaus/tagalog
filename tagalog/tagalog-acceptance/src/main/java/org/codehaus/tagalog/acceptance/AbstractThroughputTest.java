/*
 * $Id: AbstractThroughputTest.java,v 1.1 2004-12-07 14:09:10 mhw Exp $
 */
 ...
 */
public abstract class AbstractThroughputTest extends TestCase {
    ...
    protected abstract TagalogParser createParser(Reader reader)
        throws Exception;
